	...
	return (
		<div className="header">
			<Link className="link headerTitle" to="/">
				<h1 className="headerLogo">MUMBLE</h1>
			</Link>
			...
			<div className="headerNavContainer">
				...
				<Link to="/chat" className="link headerOptionBasket" onClick={(event) => {event.preventDefault(); window.open("https://minor-8e390.web.app");}}>
					<div className="headerOptionBasket">
